 ...
 *
 *
 * Operation: 'addStreamTargetToTranscoderOutput'
 * Endpoint Path: '/transcoders/{transcoder_id}/outputs/{id}/add_stream_target'
 * Method: 'post'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/transcoders/{transcoder_id}/outputs/{id}/add_stream_target',
        method: 'post',
